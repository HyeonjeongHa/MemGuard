"""Configuration and constants for MemGuard."""
...
OPENAI_EMBEDDINGS_BASE_URL = os.environ.get("OPENAI_BASE_URL", "")
OPENAI_EMBEDDINGS_API_KEY = os.environ.get("OPENAI_API_KEY", "")
...
SFT_EXPERT_MODEL = "gpt-4.1"

# Expert model for synthetic QA generation
QA_GENERATION_MODEL = "gpt-4.1"
