...
def print_accuracy_stats(results: List[Dict], title: str = "📊 Results") -> tuple:
    """
    Print accuracy statistics grouped by question type.
    ...
    print(f"\n{title}:")
    print(f"   Accuracy: {stats['correct']}/{stats['total']} ({stats['overall']*100:.2f}%)")
